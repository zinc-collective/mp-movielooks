...
static NSString* kRestVideoApiURL = @"https://api-video.facebook.com/method/";
...
-(void) requestWithMethodName:(NSString *)methodName 
	...
	if([methodName isEqualToString:@"video.upload"]){
		fullURL = [kRestVideoApiURL stringByAppendingString:methodName];
	}
